/**
 * CIWebCommsWsSoap_BindingStub.java
 *
...
public class CIWebCommsWsSoap_BindingStub extends org.apache.axis.client.Stub implements CIWebCommsWsSoap {
    ...
    private static void _initOperationDesc1() {
        ...
        oper.setReturnClass(CIMultipleOnHoldURLReadType.class);
    ...
    private static void _initOperationDesc2() {
        ...
        oper.setReturnClass(CICustomerChatNameReadType.class);
        ...
        oper.setReturnClass(CIMultipleOnHoldMessages.class);
    ...
    public CIWebCommsWsSoap_BindingStub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public CIWebCommsWsSoap_BindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public CIWebCommsWsSoap_BindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        cachedSerQNames.add(qName);
        cls = CICustomerChatNameReadType.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        cachedSerQNames.add(qName);
        cls = CIMultipleOnHoldMessages.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        cachedSerQNames.add(qName);
        cls = CIMultipleOnHoldURLReadType.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
    ...
    public CIMultipleOnHoldURLReadType getWebOnHoldURLs(String tagName, String sessionKey) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        try {
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                extractAttachments(_call);
                try {
                    return (CIMultipleOnHoldURLReadType) _resp;
                } catch (Exception _exception) {
                    return (CIMultipleOnHoldURLReadType) org.apache.axis.utils.JavaUtils.convert(_resp, CIMultipleOnHoldURLReadType.class);
                }
            }
        } catch (org.apache.axis.AxisFault axisFaultException) {
            throw axisFaultException;
    ...
    public CICustomerChatNameReadType getCustomerTextChatName(long contactID, String sessionKey) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        try {
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                extractAttachments(_call);
                try {
                    return (CICustomerChatNameReadType) _resp;
                } catch (Exception _exception) {
                    return (CICustomerChatNameReadType) org.apache.axis.utils.JavaUtils.convert(_resp, CICustomerChatNameReadType.class);
                }
            }
        } catch (org.apache.axis.AxisFault axisFaultException) {
            throw axisFaultException;
    ...
    public CIMultipleOnHoldMessages getContactOnHoldMessages(long contact_id, String sessionKey) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        try {
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                extractAttachments(_call);
                try {
                    return (CIMultipleOnHoldMessages) _resp;
                } catch (Exception _exception) {
                    return (CIMultipleOnHoldMessages) org.apache.axis.utils.JavaUtils.convert(_resp, CIMultipleOnHoldMessages.class);
                }
            }
        } catch (org.apache.axis.AxisFault axisFaultException) {
            throw axisFaultException;
