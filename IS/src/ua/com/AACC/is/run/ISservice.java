...
public class ISservice implements WrapperListener {
     ...
     * the start method. If there were no problems then this method should
     * return null.
     */
    @Override
    ...
    public void controlEvent(int event) {
        if (event == WrapperManager.WRAPPER_CTRL_SHUTDOWN_EVENT) {
    ...
    public static void main(String[] args) {
        ...
        WrapperManager.start(new ISservice(), args);
    }
}
