package ua.com.aacc.webChat.war.mBean.util;

import ua.com.aacc.webChat.war.mBean.WebChatController;
...
public class JsfUtil {
    ...
    public static void addErrorMessage(String msg) {
        FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, translate("Error"), msg);
...
//        return text;
        return ((WebChatController) FacesContext.getCurrentInstance().getApplication().getELResolver().
                getValue(FacesContext.getCurrentInstance().getELContext(), null, "webChatController")).translate(text);
    }
}