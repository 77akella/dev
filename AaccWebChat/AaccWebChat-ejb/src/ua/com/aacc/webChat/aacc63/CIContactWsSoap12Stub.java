...
public class CIContactWsSoap12Stub extends org.apache.axis.client.Stub implements CIContactWsSoap {
    ...
    private static void _initOperationDesc1() {
        ...
        oper.setReturnClass(ua.com.aacc.webChat.aacc63.CIMultipleClosedRCReadType.class);
    ...
    public CIContactWsSoap12Stub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public CIContactWsSoap12Stub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public CIContactWsSoap12Stub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        cachedSerQNames.add(qName);
        cls = ua.com.aacc.webChat.aacc63.CIMultipleClosedRCReadType.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
    ...
    public ua.com.aacc.webChat.aacc63.CIMultipleClosedRCReadType getAllClosedReasonCodes(String sessionKey) throws java.rmi.RemoteException {
        ...
        try {
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                extractAttachments(_call);
                try {
                    return (ua.com.aacc.webChat.aacc63.CIMultipleClosedRCReadType) _resp;
                } catch (Exception _exception) {
                    return (ua.com.aacc.webChat.aacc63.CIMultipleClosedRCReadType) org.apache.axis.utils.JavaUtils.convert(_resp, ua.com.aacc.webChat.aacc63.CIMultipleClosedRCReadType.class);
                }
            }
        } catch (org.apache.axis.AxisFault axisFaultException) {
            throw axisFaultException;
