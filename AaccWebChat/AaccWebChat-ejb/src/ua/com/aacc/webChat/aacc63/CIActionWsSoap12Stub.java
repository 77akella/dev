...
public class CIActionWsSoap12Stub extends org.apache.axis.client.Stub implements CIActionWsSoap {
    ...
    private static void _initOperationDesc1() {
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://datatypes.ci.ccmm.applications.nortel.com", "CIActionReadType"));
        oper.setReturnClass(CIActionReadType.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://webservices.ci.ccmm.applications.nortel.com", "ReadActionResult"));
    ...
    public CIActionWsSoap12Stub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public CIActionWsSoap12Stub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public CIActionWsSoap12Stub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        cls = ua.com.aacc.webChat.aacc63.CICustomFieldReadType[].class;
    ...
    public CIActionReadType readAction(long id, String sessionKey) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("http://webservices.ci.ccmm.applications.nortel.com/ReadAction");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP12_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://webservices.ci.ccmm.applications.nortel.com", "ReadAction"));
        ...
        try {
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                try {
                    return (CIActionReadType) _resp;
                } catch (Exception _exception) {
                    return (CIActionReadType) org.apache.axis.utils.JavaUtils.convert(_resp, CIActionReadType.class);
                }
            }
