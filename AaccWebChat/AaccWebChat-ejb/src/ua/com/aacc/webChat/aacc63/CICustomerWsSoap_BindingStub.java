/**
 * CICustomerWsSoap_BindingStub.java
 *
...
public class CICustomerWsSoap_BindingStub extends org.apache.axis.client.Stub implements CICustomerWsSoap {
    ...
    public CICustomerWsSoap_BindingStub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public CICustomerWsSoap_BindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public CICustomerWsSoap_BindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public long registerNewCustomer(CICustomerWriteType newCustomer, CIPhoneNumberWriteType newPhoneNumber, CIAddressWriteType newAddress, CIEmailAddressWriteType newEmailAddress) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
    ...
    public long registerAnonymousCustomer(CICustomerWriteType newCustomer, CIPhoneNumberWriteType newPhoneNumber) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
    ...
    public CIEmailAddressReadType getDefaultEmailAddress(long id, String sessionKey) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
    ...
    public long addPhoneNumber(long id, CIPhoneNumberWriteType newPhoneNumber, String sessionKey) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
    ...
    public long addEmailAddress(long id, CIEmailAddressWriteType newEmailAddress, String sessionKey) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
